...
export const ChatInterfaceUpdatesClientInputSchema = z.object({
  ...
  entity_session_id: z.string().describe('The entity session ID for this specific chat request.'),
  ...
  appContextLookupData: z.object({
    ...
    chargeProfileData: z.array(z.any()).nullable().optional(),
    chargeProfileLastFetched: z.date().nullable().optional(),
